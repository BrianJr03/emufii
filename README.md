...
[![Version](https://img.shields.io/badge/VERSION-1.12.8-2ea043?labelColor=3d4048&style=for-the-badge)](https://github.com/jojodogm-ctrl/emufii/releases/latest)
...
[![Consoles](https://img.shields.io/badge/CONSOLES-3DS%20%7C%20SWITCH%20%7C%20WII%20%7C%20GAMECUBE%20%7C%20PS2%20%7C%20PSP%20%7C%20DS-1b1e24?labelColor=3d4048&style=for-the-badge)](#consoles)
...
which games work. Five of the six are the console's *local* mode, the one that
...
| **PSP** | [PPSSPP](https://www.ppsspp.org) | **Ad hoc, over distance.** The PSP's own system-link mode, between two devices that are no longer in the same room. Emufii sets PPSSPP's network up for you before the game and puts your own settings back afterwards: pick the memory stick folder once, and there is no address to type. | The **ad hoc** games. Infrastructure mode, no. |
| **PS2** | [ARMSX2](https://github.com/ARMSX2/ARMSX2) | **Local Link, over distance.** The PS2's own two-console cable mode, without the cable. Played end to end at two players, and Emufii prepares the memory card the network profile needs, your saves copied onto it. Your original card or folder is never touched. | The **System Link / LAN** games. The PS2's old online servers, no. |
...
```sh
apksigner verify --print-certs Emufii-1.12.8.apk
```
