...
[![Version](https://img.shields.io/badge/VERSION-1.12.4-2ea043?labelColor=3d4048&style=for-the-badge)](https://github.com/jojodogm-ctrl/emufii/releases/latest)
...
| **PS2** | [ARMSX2](https://github.com/ARMSX2/ARMSX2) | **Local Link, over distance.** The PS2's own two-console cable mode, without the cable. New in 1.12, and honest about it: the traffic is measured going through, but no one has yet sat down and played a full match on it. Tell us how it goes. | The **System Link / LAN** games. The PS2's old online servers, no. |
...
```sh
apksigner verify --print-certs Emufii-1.12.4.apk
```
