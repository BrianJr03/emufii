...
[![Version](https://img.shields.io/badge/VERSION-1.12.3-2ea043?labelColor=3d4048&style=for-the-badge)](https://github.com/jojodogm-ctrl/emufii/releases/latest)
...
```sh
apksigner verify --print-certs Emufii-1.12.3.apk
```
